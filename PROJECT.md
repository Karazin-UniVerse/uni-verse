...
- `@universe/core` (`packages/core`): Single source of truth for cross-package contracts, models, and grade scales (exported via `@universe/core/types`).
...
| 3   | F3: Types Package Exports & Workspace Wiring         | package.json exports, tsconfig.json, typecheck scripts for @universe/core                                                                                  | M1        | ORIGINAL_REQUEST §R1                  |
...
| 7   | F7: Backend DTOs Alignment with @universe/core/types | DTOs aligned with shared contracts for /moodle/courses, /moodle/assignments, /moodle/grades, /moodle/events                                                | M3        | ORIGINAL_REQUEST §R4                  |
| 8   | F8: UniHub Package Dependencies & Imports Alignment  | Add @universe/core, consume @universe/ui from package root, replace alias imports where appropriate                                                        | M4        | ORIGINAL_REQUEST §R2, §R3             |
| 9   | F9: UniHub API Service Alignment                     | Refactor api.ts to use @universe/core/types contracts and verified endpoints                                                                               | M4        | ORIGINAL_REQUEST §R4                  |
...
| ------- | -------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ------------------- | ----------- |
| M1      | R1. Shared Domain Contracts (@universe/core)                         | F1, F2, F3: Populate packages/core/types/index.ts, tsconfig.json, package.json                | none                | DONE        |
...
| M3      | R4. Backend Moodle Gateway Alignment (@universe/backend)             | F6, F7: Default to https://moodle.universemvp.tech, align DTOs with @universe/core/types      | M1                  | DONE        |
...
### `@universe/core/types` ↔ Workspace Consumers
...
- `packages/core/types/index.ts`: Domain models and calculation utilities.

...
│   ├── f1-domain-models.test.ts            # F1: Спільні моделі @universe/core (6 тестів)
...
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ------------------ |
| **F1: Shared Core Domain Models**      | `StudentProfile`, `CurriculumItem`, `StudentRecordBookItem`, `AssignmentItem`, `ScheduleItem`, `LmsConnectionStatus` у `packages/core/types` | **PASS (6/6)** | M1                 |
...
| **F3: Types Package Exports**          | Експорти в `packages/core/package.json` та конфігурація `tsconfig.json`                                                                      | **PASS**       | M1                 |

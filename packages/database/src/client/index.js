...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\TipTop230\\.gemini\\antigravity\\scratch\\uni-verse\\packages\\database\\src\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\TipTop230\\.gemini\\antigravity\\scratch\\uni-verse\\packages\\backend\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  ...
  "inlineSchemaHash": "ae2cf386ddd215b5c7cd2e2e7898f04fe6e59daf2ca258d0467e627d3b0313cd",
  "copyEngine": true
}
...
path.join(process.cwd(), "../database/src/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../database/src/client/schema.prisma")
